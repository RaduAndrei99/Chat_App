...
ALTER TABLE relationship_settings ADD CONSTRAINT relationship_settings_pk PRIMARY KEY ( relationship_id );
...
ALTER TABLE relationship_settings
    ADD CONSTRAINT relationship_settings_friend_relationships_fk FOREIGN KEY ( relationship_id )
