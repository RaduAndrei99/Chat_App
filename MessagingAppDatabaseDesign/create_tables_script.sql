...
ALTER TABLE messages
    ADD CONSTRAINT seen_ck CHECK ( seen IN ( 'F', 'T' ) );
...
--  ERROR: Column name length exceeds maximum allowed length(30) 
    friend_relationships_relationship_id  NUMBER(13) NOT NULL
);

ALTER TABLE relationship_settings ADD CONSTRAINT relationship_settings_pk PRIMARY KEY ( friend_relationships_relationship_id );
...
ALTER TABLE users
    ADD CONSTRAINT is_active_ck CHECK ( is_active IN ( 'F', 'T' ) );
...
ALTER TABLE relationship_settings
    ADD CONSTRAINT relationships_fk FOREIGN KEY ( friend_relationships_relationship_id )
